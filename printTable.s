@ printTable.s
@ This function takes as input the address of the first array index and
 @ the size of the array. It then prints the total number of times each value 
 @ (2-12) was generated by the two calls to the rollDie function.
